...
void raytracing::extensions::imgui::imgui_renderer::resolve(
...
void raytracing::extensions::imgui::imgui_renderer::update(const runtime_service& service, const runtime_frame& frame)
{
	wrapper::directx12::extensions::imgui_context::new_frame();
	ImGui::NewFrame();
}

void raytracing::extensions::imgui::imgui_renderer::render(const runtime_service& service, const runtime_frame& frame)
{
...
ImTextureID raytracing::extensions::imgui::imgui_renderer::allocate(const wrapper::directx12::texture2d& resource,
	size_t index) const
{
